...
import { askForPermissionToReceiveNotifications } from '../lib/firebase';
...
function Intro() {
  ...
  return (
      <div className='w-full h-full flex flex-col justify-center items-center bg-gray-900 text-primary pb-20 relative scrollbar-hide p-8'>
