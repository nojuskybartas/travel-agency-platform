    ...
    return (
      ...
      >
        {({ getInputProps, suggestions, getSuggestionItemProps, loading }) => (
          <div className='w-full h-full flex items-center border-b-2 border-solid border-gray-800 relative transition-long'>
            <Field
              name={field.name}
              {...getInputProps({
            ...
            <div className="autocomplete-dropdown-container w-full h-fit absolute bottom-0 transition-long px-6 bg-gray-400 z-10 inputBarSuggestions_shadow rounded-b-xl translate-y-full">
