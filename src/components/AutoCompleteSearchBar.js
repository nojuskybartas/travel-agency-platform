...
function ProductItem({ hit, components, navigate }) {
    return (
      <div className="aa-ItemWrapper" onClick={() => navigate(`/experience/${hit.objectID}`)}>
        <div className="aa-ItemContent">
          <img src={hit.images[0]} alt={hit.title} className='w-8 h-8 object-cover rounded-lg' />
