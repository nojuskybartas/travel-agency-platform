...
function NavBar() {
    ...
    return (
        <div className='md:hidden w-1/4'>
            ...
            <nav className={`fixed bg-[#3b443eb7] backdrop-filter backdrop-blur-lg -top-2 -bottom-2 right-1/4 -left-2 z-10 ${visible ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-200 ease-out`}>
                <ul className='relative w-full h-full flex flex-col text-white font-semibold text-xl space-y-7 py-36 px-20'>
